...
module.exports = do ->
  ...
  app.get '/Alerts', AlertController.find
  app.get '/Alerts/:id', AlertController.get
  app.post '/Alerts', AlertController.create
  app.put '/Alerts/:id', AlertController.update
  app.delete '/Alerts/:id', AlertController.destroy
